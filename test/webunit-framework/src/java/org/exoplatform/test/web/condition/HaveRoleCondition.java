 ...
 * @version: $Id: HaveRoleCondition.java,v 1.1 2004/10/11 23:36:04 tuan08 Exp $
 **/
public class HaveRoleCondition implements Condition {
  private String role_ ;
  
  public HaveRoleCondition(String role) {
    role_ = role ;
  }
  ...
  public String getName() { return "HaveRoleCondition" ; }
  public String getDescription() {
    return "This unit test should run only if the remote user has the role '" + role_ + "'" ;
  }
}