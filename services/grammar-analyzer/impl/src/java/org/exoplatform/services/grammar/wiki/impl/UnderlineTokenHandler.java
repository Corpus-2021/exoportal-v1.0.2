 ...
 * @version $Id$
 */
public class UnderlineTokenHandler extends TokenHandler {
  ...
  public String[] getHandleableTokenType() { return new String[]{Token.UNDERLINE_TOKEN} ;}
}