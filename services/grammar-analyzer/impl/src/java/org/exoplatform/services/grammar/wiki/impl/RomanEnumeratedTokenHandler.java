 ...
 * @version $Id$
 */
public class RomanEnumeratedTokenHandler extends TokenHandler {
  ...
  public Token handleToken(Token parent, Token token, ParsingContext context)  {
    ...
    b.append("<ul class='roman-enumerated'>") ;
    boolean closeLI = false ;
    while(token != null) {
      if(token.type == Token.ROMAN_ENUMERATED_TOKEN) {
  ...
  public String[] getHandleableTokenType() {
    String[] s  = { Token.ROMAN_ENUMERATED_TOKEN } ;
    return s;
  }
}