...
public class XMLNativeArray {
  ...
  public void   setType(Object o) {
    if(o instanceof int[]) type = XMLBaseObject.INT ;
    else if(o instanceof long[]) type = XMLBaseObject.LONG ;
    else if(o instanceof float[]) type = XMLBaseObject.FLOAT ;
    else if(o instanceof double[]) type = XMLBaseObject.DOUBLE ;
    else if(o instanceof boolean[]) type = XMLBaseObject.BOOLEAN ;
  }
  
  public Object getValue() { return array ; }
  
  public String getArray() { 
    if(type.equals(XMLBaseObject.INT))   return encodeIntArray((int[]) array) ;
    else if(type.equals(XMLBaseObject.LONG)) return encodeLongArray((long[]) array)  ;
    else if(type.equals(XMLBaseObject.DOUBLE)) return encodeDoubleArray((double[]) array)  ;
    else throw new RuntimeException("Unknown array type: " + type ) ;
  }
  
  public void setArray(String text) {
    if(type.equals(XMLBaseObject.INT)) array = decodeIntArray(text) ;
    else if(type.equals(XMLBaseObject.LONG)) array = decodeLongArray(text) ;
    else if(type.equals(XMLBaseObject.DOUBLE)) array = decodeDoubleArray(text) ;
  }
  ...
  static public boolean isNativeArray(Object o) {
    if(o instanceof int[]  || 
       ...
       o instanceof float[] ||
       o instanceof double[] ||
       o instanceof boolean[]) return true ;
    return false ;
  }
  ...
  static public boolean isNativeArray(Class clazz) {
    if(clazz.equals(int[].class)  || 
       ...
       clazz.equals(boolean[].class) ) return true ;
    return false ;
  }
}